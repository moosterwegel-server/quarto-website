...
Consider the following p-values, and the accompanying FDR calculation[^4]:

[^4]: The original BH procedure did not [include](https://stats.stackexchange.com/a/287199) 'adjusted' p-values. The calculation I present yields identical results to their procedure and is (in my opinion) easier to follow. `p.adjust` also follows this calculation.
